...
if __name__ == '__main__':
    ...
    for element in winlist:
        ...
        #writing in 3 parts
        if winlist.index(element) == 1800:
            resultdf.to_csv('win56 p1.csv', index = False)
        elif winlist.index(element) == 3600:
            resultdf.to_csv('win56 p2.csv', index = False)
        
                
    resultdf.to_csv('win56 .csv', index = False)
